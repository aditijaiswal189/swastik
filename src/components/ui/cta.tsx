      ...
      <Container>
        <div className="relative">
          ...
          <div className="mt-6 m-auto space-y-6 md:w-8/12 lg:w-7/12 text-center">
            <h1 className="text-4xl font-bold text-gray-800 a:text-white md:text-5xl">
              Express Entry
            </h1>
            <p className="text-xl text-gray-600 a:text-gray-300">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <div className="flex flex-wrap justify-center gap-6">
                  ...
                  >
                    <span className="relative text-base font-semibold text-white a:text-a">
