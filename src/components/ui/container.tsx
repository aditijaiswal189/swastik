...
export default function Container({
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        <div
          className={`blur-[126px] h-56 bg-gradient-to-br from-primary to-purple-400  ${gradientClassName}`}
        ></div>
        <div
          className={`blur-[126px] h-32 bg-gradient-to-r from-cyan-400 to-sky-300  ${secondaryGradientClassName}`}
        ></div>
      </div>
    </div>
  );
